...
?>
    ...
    <!-- This prints out values that were passedto the action page using the method called "get"-->
      <!--  <div class="card" style="width: 18rem;">
        ...
        <!-- This prints out values that were passed to the page using the method "post-->
        ...
        <div class="card" style="width: 18rem;">
            <div class="card-body">
                ...
                <h6 class="card-subtitle mb-2 text-muted">
                    Specialty: <?php echo $specialtyName['name']; ?> 
                </h6>
                <p class="card-text">
